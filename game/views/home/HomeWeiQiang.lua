--
-- Author: 
-- Date: 2017-11-24 11:09:33
--
local HomeWeiQiang = class("HomeHouse", base.BaseView)


local _type = 2001
local _level = "wallLev"
local _tilteicon = "jiayuan_104"

function HomeWeiQiang:ctor()
    self.super.ctor(self)
    self.uiLevel = UILevel.level3 
    self.openTween = ViewOpenTween.scale
end

function HomeWeiQiang:initView()
...
function HomeWeiQiang:initData()
    -- body
    self:setData()
end

function HomeWeiQiang:cellData(index, obj)
    -- body
...
function HomeWeiQiang:setData(data_)
    self.money.text = cache.PlayerCache:getTypeMoney(MoneyType.home)
...
function HomeWeiQiang:onClickItemCall(context)
    -- body
    local data = context.data.data
end

function HomeWeiQiang:onHouseUp()
    -- body
