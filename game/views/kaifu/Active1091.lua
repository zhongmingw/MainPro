--
-- Author: 
-- Date: 2018-07-03 19:43:32
--

local Active1091 = class("Active1091",import("game.base.Ref"))

function Active1091:ctor(param)
    self.view = param
    self:initView()
end

function Active1091:initView()
...
--快速升级途径
function Active1091:initUpListView()
    local actId 
...
--跳转到对应系统
function Active1091:onCallGoto(context)
    local formView = context.data.data
    GOpenView({id = formView[1], childIndex = formView[2]})
end
--其他排行奖励
function Active1091:initOtherRankReward()
...
function Active1091:cellData(index, obj)
...
function Active1091:setCurId(id)
    -- body
    self.id = id
    
end
function Active1091:onTimer()
...
function Active1091:onRankingView()
...
function Active1091:add5030409(data)
    -- printt("里面",data)
    self.data = data
...
function Active1091:setFirstAward()
    self:initUpListView() --*升级途径
    local activeData = cache.ActivityCache:get5030111()
    ...
    self.titleImg.url = UIPackage.GetItemURL("kaifu" , "kaifupaihang_075")
