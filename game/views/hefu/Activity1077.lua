--开服累充
local Activity1077 = class("Activity1077",import("game.base.Ref"))

function Activity1077:ctor(param)
    self.view = param
    self:initView()
end

function Activity1077:initView()
    -- body
...
function Activity1077:celldata( index, obj )
    -- body
...
function Activity1077:setCurId(id)
    -- body
    self.id = id
    
end

function Activity1077:setOpenDay( day )
    -- body
    
end

function Activity1077:onChongzhi()
    -- body
    mgr.ViewMgr:closeAllView2()
    GGoVipTequan(0)
end
function Activity1077:onClickGet(context)
...
function Activity1077:add5030185( data )
    -- body
    self.data = data
...
function Activity1077:isGet(id)
...
function Activity1077:canGet(id)
