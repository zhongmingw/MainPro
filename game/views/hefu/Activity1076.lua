--开服累充
local Activity1076 = class("Activity1076",import("game.base.Ref"))

function Activity1076:ctor(param)
    self.view = param
    self:initView()
end

function Activity1076:initView()
    -- body
...
function Activity1076:celldata( index, obj )
    -- body
...
function Activity1076:setCurId(id)
    -- body
    self.id = id
    
end

function Activity1076:setOpenDay( day )
    -- body
    
end

function Activity1076:onChongzhi()
    -- body
    mgr.ViewMgr:closeAllView2()
    GGoVipTequan(0)
end
function Activity1076:onClickGet(context)
...
function Activity1076:add5030184( data )
    -- body
    self.data = data
...
function Activity1076:isGet(id)
